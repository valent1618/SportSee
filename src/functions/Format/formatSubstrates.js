 ...
 * @returns { Array.<{name: string, unit: string, value: number, icon: svg}>}
 */
function formatSubstrates(substrates) {
  let newSubstrates = [
    ...
    },
    {
      name: 'Glucides',
      unit: 'g',
      value: substrates.carbohydrateCount,
      icon: (
        <svg
          width='18'
          height='20'
...
export default formatSubstrates;
